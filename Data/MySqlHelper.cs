...
namespace Data
{
    public class MySqlHelper
    {
        ...
        /// <returns>影响的记录数</returns> 
        public static List<string> ExecuteNonQueryOutValue(string SQLString, Action<MySqlCommand, List<string>> outParaAction, params MySqlParameter[] cmdParms)
        {
        ...
        /// <param name="SQLString">查询语句</param> 
        /// <returns>DataTable</returns> 
        public static DataSet ExecuteDataSet(string connectionStr, string SQLString, params MySqlParameter[] cmdParms)
        {
